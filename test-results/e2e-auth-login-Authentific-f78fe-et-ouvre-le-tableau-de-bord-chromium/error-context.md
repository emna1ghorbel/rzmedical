...
- Name: e2e\auth\login.spec.ts >> Authentification admin >> termine le flux réel en deux étapes et ouvre le tableau de bord
- Location: tests\e2e\auth\login.spec.ts:28:7
